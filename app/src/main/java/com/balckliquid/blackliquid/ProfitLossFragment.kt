...
import com.balckliquid.blackliquid.models.Calculations
 ...
 * Use the [ProfitLossFragment.newInstance] factory method to
...
class ProfitLossFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val student = Calculations.expenses()
    }
